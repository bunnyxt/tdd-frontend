...
<template>
  <div>
    \<div v-wechat-title="$t('page_title.me_setting')"></div>
    <div class="tdd-breadcrumb">
      <a-breadcrumb>
        ...
        <a-breadcrumb-item>{{ $t('page_name.me_setting') }}</a-breadcrumb-item>
      </a-breadcrumb>
    </div>
      ...
      <div v-else>
        <a-form :form="form" :label-col="{ span: 5 }" :wrapper-col="{ span: 14 }" style="padding: 12px">
          ...
          <a-form-item label="昵称">
            ...
            <a-modal title="设置昵称" v-model:visible="setNicknameModalVisibility">
              <template #footer>
          ...
          <a-form-item label="邮箱">
            ...
            <div v-else>
              ...
              >绑定</a-button>
              <a-modal title="绑定邮箱" v-model:visible="bindEmailModalVisibility">
                <template #footer>
                  <a-button type="primary" @click="() => bindEmailModalVisibility = false">完成</a-button>
                </template>
          ...
          <a-form-item label="手机">
            ...
            <div v-else>
              ...
              >绑定</a-button>
              <a-modal title="绑定手机" v-model:visible="bindPhoneModalVisibility">
                <template #footer>
          ...
          <a-form-item label="密码">
            ...
            <a-modal title="修改密码" v-model:visible="changePasswordModalVisibility">
              <template #footer>
